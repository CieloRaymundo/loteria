...
class Game implements GameInterface{
    ...
    checkLoteria(player: any, deck: DeckInterface): boolean{
        ...
        let includesAll: boolean = playerMarked.every(function(iconId: number) { return deckCalledIcons.indexOf(iconId) >= 0; });
        ...
        for (let i = 0; i < conditions.length; i++) {
            ...
            let card: PlayerCardInterface = player.playerCard;
